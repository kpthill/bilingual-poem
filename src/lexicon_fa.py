...
FA_BLOCKLIST = {"اوه","اه","هوم","اوم","خب","اووه","هان","ووه","اهم",
                ...
                # judge-flagged ghosts/archaisms
                "ار","اندر","ایل","هاد","لی","ها","کاه","اند",
                "هین","مگ","کون","گیک","علی","اید","ایدی","حین","هیل","حالو","هوک"}
...
NO_SUFFIX = {"هر","که","و","تا","از","به","با","هم","چه","اگر","یا","پس",
             ...
             # finite verbs / copulas: no ezâfe or nominal clitics
             "بود","دید","رفت","شد","کرد","گفت","ماند","است","نیست","هست",
             "باد","آمد","داد","زد","خورد","برد","مرد","بست","یافت","سوخت"}
